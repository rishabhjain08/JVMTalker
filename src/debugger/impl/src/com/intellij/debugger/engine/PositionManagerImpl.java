...
public class PositionManagerImpl implements PositionManager, MultiRequestPositionManager {
  ...
  @Nullable
  public SourcePosition getSourcePosition(final Location location, PsiFile myPsiFile) throws NoDataException {
    ...
    PsiFile psiFile = getPsiFileByLocation(project, location, myPsiFile);
    if(psiFile == null ) {
      return null;
    }
  ...
  public SourcePosition getSourcePosition(@Nullable Location location) throws NoDataException {
    return getSourcePosition(location, null);
  }
  ...
  @Nullable
  protected PsiFile getPsiFileByLocation(final Project project, final Location location, PsiFile psiFile) {
    if (location == null) {
      return null;
    }
